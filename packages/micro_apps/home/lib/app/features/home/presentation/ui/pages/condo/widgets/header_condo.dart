...
class HeaderCondo extends StatefulWidget {
  final double _height;
  final bool _showIcon;

  const HeaderCondo(this._height, this._showIcon, {Key? key}) : super(key: key);

  @override
  _HeaderCondoState createState() => _HeaderCondoState(_height, _showIcon);
}

class _HeaderCondoState extends State<HeaderCondo> {
  double _height;
  bool _showIcon;

  _HeaderCondoState(this._height, this._showIcon);
